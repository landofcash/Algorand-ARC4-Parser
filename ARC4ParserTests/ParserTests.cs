namespace Aldemart.ARC4ParserTests
{
    ...
    internal class ParseProductTests : BaseTests
    {
        private StructTypeNode LoadStructType(string fileName)
        {
            ...
            StructTypeNode? structTypeNode = JsonSerializer.Deserialize<StructTypeNode>(json);
            if (structTypeNode == null) throw new Exception("Can't deserialize json");
            Logger.LogInformation($"Kind: {structTypeNode.GetType().Name} Name: {structTypeNode.Name}");
        ...
        public void TestNodeParser()
        {
            ...
            string result = JsonSerializer.Serialize(product);
